						   ...
						   <!-- Autor -->
							...
							<div class="sharewrap">
								<p class="calltoshare">
									...
									<a href="https://t.me/share/url?url=<?php the_permalink() ?>&text=<?php the_title(); ?>" class="telegram" title="Auf Telegram teilen">Telegram</a>
									<a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink() ?>" class="facebook" title="Auf Facebook teilen">Facebook</a>
